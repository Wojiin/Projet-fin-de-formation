  ...
  <aside class="app-sidebar">
    <div class="px-7 pb-7 pt-8">
      <RouterLink to="/programme" class="block rounded-md">
        <span class="text-2xl font-bold tracking-tight text-gray-950 dark:text-white">Chir<span class="text-chirorg-600">Org</span></span>
        <span class="mt-1 block text-xs text-gray-500 dark:text-gray-400">Bloc opératoire</span>
      </RouterLink>
    </div>
