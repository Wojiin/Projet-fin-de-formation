...
/** Réceptionne les illustrations des consignes techniques administratives. */
#[IsGranted('ROLE_ADMIN')]
final class TechnicalSheetImageUploadController extends AbstractController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $relativeDirectory = '/uploads/fiches-techniques';
        $targetDirectory = $this->projectDir.'/public'.$relativeDirectory;
        (new Filesystem())->mkdir($targetDirectory, 0775);
        ...
        return $this->json(['url' => $relativeDirectory.'/'.$filename], Response::HTTP_CREATED);
    }
}
